...
const BACKEND_PORT = Number(process.env.PROMATCH_PLAYWRIGHT_BACKEND_PORT ?? 8000);
...
backendEnv.PROMATCH_E2E_BYPASS_AUTH = backendEnv.PROMATCH_E2E_BYPASS_AUTH ?? '1';
backendEnv.PROMATCH_E2E_BYPASS_TOKEN = backendEnv.PROMATCH_E2E_BYPASS_TOKEN ?? 'e2e-playwright';
backendEnv.PROMATCH_E2E_BYPASS_EMAIL = backendEnv.PROMATCH_E2E_BYPASS_EMAIL ?? 'e2e@example.com';
backendEnv.PROMATCH_E2E_BYPASS_NAME = backendEnv.PROMATCH_E2E_BYPASS_NAME ?? 'E2E Admin';
