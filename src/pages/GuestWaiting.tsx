          ...
          <div className="text-center">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
              <p className="text-gray-700 mb-2">
                {t(
                  "guest.message",
                  "Your account is pending approval. An administrator needs to grant you access to the platform.",
                )}
              </p>
            </div>
            ...
            <div className="flex items-start gap-3 text-left bg-gray-50 rounded-lg p-4">
              ...
              <div className="text-sm text-gray-600">
                ...
                <p>
                  {t(
                    "guest.contactMessage",
                    "Contact your system administrator to request analyst access.",
                  )}
                </p>
              </div>
            </div>
