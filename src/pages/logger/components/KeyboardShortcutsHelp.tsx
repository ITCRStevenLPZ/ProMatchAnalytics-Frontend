...
const SHORTCUT_CATEGORIES: ShortcutCategory[] = [
  {
    ...
    shortcuts: [
      ...
      { key: 'Y', description: 'Card (Yellow/Red)' },
    ...
    >
      ...
      >
        ...
        <div className="p-4 overflow-y-auto max-h-[calc(80vh-80px)]">
          ...
          <div className="mt-6 bg-blue-50 rounded-lg p-4">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• Type jersey numbers quickly to select players (e.g., "10" + Enter)</li>
              <li>• Use Space to pause/resume the clock during stoppages</li>
              <li>• Recent players appear at the top for quick re-selection</li>
              <li>• Quick action bar shows most-used actions with single key press</li>
            </ul>
          </div>
        </div>
        ...
        <div className="p-3 border-t bg-gray-50 text-center text-sm text-gray-500">
          Press <kbd className="bg-gray-200 px-1.5 py-0.5 rounded text-xs font-mono">?</kbd> anytime to toggle this help
        </div>
      </div>
    </div>
  );
