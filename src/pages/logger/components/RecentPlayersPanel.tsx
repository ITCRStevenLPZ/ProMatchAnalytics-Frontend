...
const RecentPlayersPanel: React.FC<RecentPlayersPanelProps> = ({
  ...
  return (
    <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-3 mb-4" data-testid="recent-players-panel">
...
export const useRecentPlayers = (maxHistory = 10) => {
  ...
  const addRecentPlayer = React.useCallback((
    ...
    setRecentPlayers(prev => {
      ...
      const existingIndex = prev.findIndex(rp => rp.player.id === player.id);
