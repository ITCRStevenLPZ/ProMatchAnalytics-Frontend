        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="inline-flex items-center gap-1 bg-amber-200 text-amber-900 px-2 py-0.5 rounded-full text-xs font-mono font-bold">
              <Clock size={12} />
              +{formatTime(extraTimeSeconds)}
            </span>
          </div>
          
          <p className="text-sm text-amber-800 mb-3">
            {isFirstHalf
              ? t('extraTime.firstHalfMessage', 'The first half has exceeded 45 minutes. Transition to halftime when ready.')
              : t('extraTime.secondHalfMessage', 'The second half has exceeded 45 minutes. You can end the match when ready.')
            }
          </p>
