...
export default function PlayersManager() {
  ...
  const [originalFormData, setOriginalFormData] =
    useState<Partial<PlayerData> | null>(null);
  ...
  const formatDeleteGuardError = (detail: unknown): string | null => {
    ...
    const match = detail.match(
      /Cannot delete player with (\d+) team assignment(?:s)?/i,
    );
      ...
      <div className="card grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="relative">
          ...
          <select
            ...
            onChange={(e) =>
              setPositionFilter(e.target.value as PlayerPosition | "")
            }
            className="input pl-10 w-full"
          >
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredPlayers.map((item) => (
                    <tr key={item._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-500">
                        {item.player_height ? `${item.player_height} cm` : "-"}
                      </td>
                      <td className="px-6 py-4 text-sm text-gray-500">
                        {item.player_weight ? `${item.player_weight} kg` : "-"}
                      </td>
                      {user?.role === "admin" && (
                        <td className="px-6 py-4 text-right text-sm font-medium space-x-2">
                          ...
                          <button
                            onClick={() => handleDelete(item.player_id)}
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full my-8">
            <div className="flex justify-between items-center p-6 border-b sticky top-0 bg-white z-10 rounded-t-lg">
              <h2 className="text-2xl font-bold">
                {editingItem ? t("edit") : t("createPlayer")}
              </h2>
              <button
            ...
            >
              ...
              <div>
                <AutocompleteSearch<PlayerApiResponse>
                  ...
                  getSecondaryText={(player) =>
                    `${
                      player.country_name ||
                      player.nationality ||
                      t("unknownCountry")
                    } • ${player.position} • ${player.birth_date}`
                  }
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`input w-full ${
                      getFieldError("birth_date") ? "border-red-500" : ""
                    }`}
                  />
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onBlur={(e) =>
                      validateAndSetFieldError("position", e.target.value)
                    }
                    className={`input w-full ${
                      getFieldError("position") ? "border-red-500" : ""
                    }`}
                  >
                    <optgroup label={t("positionGroups.goalkeeper")}>
                      <option value="GK">{t("positions.GK")}</option>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`input w-full ${
                      getFieldError("player_height") ? "border-red-500" : ""
                    }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`input w-full ${
                      getFieldError("player_weight") ? "border-red-500" : ""
                    }`}
                  />
            ...
            <div className="flex justify-end space-x-3 p-6 border-t sticky bottom-0 bg-white z-10 rounded-b-lg">
              ...
              <button
                ...
                className={`btn btn-primary ${
                  showChangeWarning || showSimilarRecords
