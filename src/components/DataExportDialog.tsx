...
interface DataExportDialogProps {
  modelType: 'competitions' | 'venues' | 'referees' | 'players' | 'teams' | 'matches';
  isOpen: boolean;
  onClose: () => void;
}
...
export function DataExportDialog({ modelType, isOpen, onClose }: DataExportDialogProps) {
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              {t('ingestion.exportInfo', { model: t(`ingestion.${modelType}`).toLowerCase(), format: format.toUpperCase() })}
            </p>
          </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className={`text-sm font-semibold mb-1 ${
                    ...
                    {result.success ? t('ingestion.exportSuccess') : t('ingestion.exportFailed')}
                  </h3>
                  {result.success ? (
                    <>
