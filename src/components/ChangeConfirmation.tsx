        ...
        <div className="flex-1">
          ...
          <div className="space-y-2 mb-4 max-h-96 overflow-y-auto">
            {changes.map((change, index) => (
              <div
                key={index}
                className="bg-white rounded-lg p-3 text-sm border border-gray-200 shadow-sm"
              >
                <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="text-xs font-medium px-2 py-1 rounded bg-blue-100 text-blue-800">
                    ...
                    {t("changeConfirmation.changed")}
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div>
                    <div className="text-gray-500 mb-1 font-medium">
                      {t("changeConfirmation.original")}:
                    </div>
          ...
          <div className="flex space-x-2">
            ...
            <button onClick={onConfirm} className="btn btn-primary text-sm">
