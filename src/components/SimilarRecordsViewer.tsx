                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <div className="text-xs text-gray-600 mt-1">
                        {record.match_details && record.match_details.join(' • ')}
                      </div>
                    </div>
                    <div className="flex items-center space-x-4">
                      <div className="text-right">
                        <div className="text-xs text-gray-500">{t('duplicateWarning.similarity')}</div>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {getDisplayFields().map(field => {
                          const currentValue = getFieldValue(currentData, field);
                          return (
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {getDisplayFields().map(field => {
                          ...
                          const isDifferent = formatFieldValue(currentValue) !== 
