...
export const validationMessageMap: Record<string, string> = {
  ...
  'Player name must not exceed 100 characters': 'validationErrors.playerNameMax',
  'Player ID must not exceed 40 characters': 'validationErrors.playerIdMax',
  'Player ID must use letters, numbers, underscores, or hyphens': 'validationErrors.playerIdFormat',
  ...
  'Manager name must be at least 2 characters': 'validationErrors.managerNameMin',
  'Manager name must not exceed 100 characters': 'validationErrors.managerNameMax',
  'Manager nationality is required': 'validationErrors.managerNationalityRequired',
  'Manager nationality must be at least 2 characters': 'validationErrors.managerNationalityMin',
  'Manager nationality must not exceed 100 characters': 'validationErrors.managerNationalityMax',
  ...
  'Years of experience must be a valid number': 'validationErrors.yearsExpInvalid',
  ...
  'Referee name must be at least 2 characters': 'validationErrors.refereeNameMin',
  'Referee name must not exceed 100 characters': 'validationErrors.refereeNameMax',
  'Referee ID must not exceed 40 characters': 'validationErrors.refereeIdMax',
  'Referee ID must use letters, numbers, underscores, or hyphens': 'validationErrors.refereeIdFormat',
  ...
  'Venue ID must use letters, numbers, underscores, or hyphens': 'validationErrors.venueIdFormat',
  ...
  'Surface must be Natural Grass, Artificial Turf, or Hybrid': 'validationErrors.surfaceInvalid',

  // Competition validation
  'Competition name is required': 'validationErrors.competitionNameRequired',
  'Competition name must be at least 2 characters': 'validationErrors.competitionNameMin',
  'Competition name must not exceed 100 characters': 'validationErrors.competitionNameMax',
  'Competition ID must not exceed 40 characters': 'validationErrors.competitionIdMax',
  'Competition ID must use letters, numbers, underscores, or hyphens': 'validationErrors.competitionIdFormat',
  'Competition ID already exists': 'validationErrors.competitionIdExists',
  'Localized name must not exceed 100 characters': 'validationErrors.localizedNameMax',
};
