...
export const validationMessageMap: Record<string, string> = {
  ...
  'Nationality is required': 'validationErrors.nationalityRequired',
  'Nationality must be at least 2 characters': 'validationErrors.nationalityMin',
  'Nationality must not exceed 100 characters': 'validationErrors.nationalityMax',
